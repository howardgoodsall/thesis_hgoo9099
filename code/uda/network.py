...
class DecafBase(nn.Module):
  def __init__(self):
    ...
    model = AlexNet_BVLC()
    model_old = torch.load('/Checkpoint/liangjian/tran/icml20/alexnet_caffe.pth.tar')#'../pretrained_models/alexnet_caffe.pth.tar'
    st = model.state_dict()
...
def alexnet(pretrained=False, **kwargs):
    ...
    if pretrained:
        model_path = '/Checkpoint/liangjian/tran/icml20/alexnet.pth.tar'#'../pretrained_models/alexnet_caffe.pth.tar'
